-- https://www.townlong-yak.com/framexml/57171/Blizzard_SharedXML/TimeUtil.lua

-- Set to false in some locale specific files.
if TIME_UTIL_WHITE_SPACE_STRIPPABLE == nil then TIME_UTIL_WHITE_SPACE_STRIPPABLE = true; end

if not SECONDS_PER_MIN then SECONDS_PER_MIN = 60; end
if not SECONDS_PER_HOUR then SECONDS_PER_HOUR = 60 * SECONDS_PER_MIN; end
if not SECONDS_PER_DAY then SECONDS_PER_DAY = 24 * SECONDS_PER_HOUR; end
if not SECONDS_PER_MONTH then SECONDS_PER_MONTH = 30 * SECONDS_PER_DAY; end
if not SECONDS_PER_YEAR then SECONDS_PER_YEAR = 12 * SECONDS_PER_MONTH; end

if not SecondsToMinutes then
	function SecondsToMinutes(seconds)
		return seconds / SECONDS_PER_MIN;
	end
end

if not MinutesToSeconds then
...
if not SecondsFormatter then SecondsFormatter = {}; end

if not SecondsFormatterConstants then
...
if SecondsFormatter.Abbreviation == nil then
...
if SecondsFormatter.Interval == nil then
...
if SecondsFormatter.IntervalDescription == nil then
