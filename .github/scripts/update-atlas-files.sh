...
for version in wow
do
  wget -O "UiTextureAtlas.csv" "https://wago.tools/db2/UiTextureAtlas/csv?build=8.0.1.26367"
  wget -O "UiTextureAtlasMember.csv" "https://wago.tools/db2/UiTextureAtlasMember/csv?build=8.0.1.26367"
